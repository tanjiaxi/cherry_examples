...
type User struct {
	...
	DeviceName    string                 `protobuf:"bytes,7,opt,name=deviceName,proto3" json:"deviceName,omitempty"` // 设备名
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_rpc_proto_rawDesc = string([]byte{
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x70, 0x22, 0xa4, 0x01, 0x0a, 0x04, 0x55, 0x73,
