...
type Int32Int64Map struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Value         map[int32]int64        `protobuf:"bytes,1,rep,name=value,proto3" json:"value,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_base_type_proto_rawDesc = string([]byte{
