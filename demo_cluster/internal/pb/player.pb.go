...
type GetUserInfoResponse struct {
	...
	Money         int64                  `protobuf:"varint,2,opt,name=money,proto3" json:"money,omitempty"`     // 金币
...
func (x *GetUserInfoResponse) GetMoney() int64 {
	if x != nil {
		return x.Money
	}
	return 0
...
var file_player_proto_rawDesc = string([]byte{
	...
	0x01, 0x28, 0x03, 0x52, 0x05, 0x6d, 0x6f, 0x6e, 0x65, 0x79, 0x12, 0x18, 0x0a, 0x07, 0x64, 0x69,
